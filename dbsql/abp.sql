...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 17, 2023 at 03:04 AM
...
INSERT INTO `course_infos` (`id`, `course_title`, `course_category_id`, `course_image`, `course_document`, `course_duration`, `course_description`, `created_at`, `updated_at`) VALUES
...
(2, 'programming c#', 1, '1692219059.dorF.webp', 'storage/', '2 month', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged', '2023-08-16 14:50:59', '2023-08-16 14:50:59'),
(3, 'python', 1, '1692219089.blog-top-section.webp', 'storage/', '5 month', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged', '2023-08-16 14:51:29', '2023-08-16 14:51:29'),
(4, 'web develop', 1, '1692220559.Creative-Thinking-The-skill-to-think-out-of-the-box.webp', 'storage/', '2 month', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.', '2023-08-16 15:15:59', '2023-08-16 15:15:59');
...
CREATE TABLE `users` (
  ...
  `course_infos_id` int(192) NOT NULL,
...
(2, 'user', 'user@gmail.com', '0', 'apruv', 4, NULL, '$2y$10$rwcfsRhGi1nbjGGTevLMe.7RKd0iWmvgJna79HUXtzs8w/b48cCZS', NULL, '2023-08-16 16:57:33', '2023-08-16 17:00:24');
